...
import wandb
from datasets import Mydataset_CAMUS_Multitask,Mydataset_HMC_MultiTask
...
for fold in range(1, 2):
    ...
    # HMC数据
    # train_dataset = Mydataset_HMC_MultiTask(split="train", fold=fold)
    # test_dataset = Mydataset_HMC_MultiTask(split="test", fold=fold)
